...
class CarouselImage(models.Model):
    portal      = models.ForeignKey(PortalSetting, on_delete=models.CASCADE, related_name='carousel_images')
...
class PortalCard(models.Model):
    portal      = models.ForeignKey(PortalSetting, on_delete=models.CASCADE, related_name='cards')
